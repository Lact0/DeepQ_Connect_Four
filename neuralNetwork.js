...
class NeuralNetwork {
  ...
  copy() {
    const child = new NeuralNetwork(this.numIn, this.dim, this.params);
    child.weights = JSON.parse(JSON.stringify(this.weights));
    child.biases = JSON.parse(JSON.stringify(this.biases));
